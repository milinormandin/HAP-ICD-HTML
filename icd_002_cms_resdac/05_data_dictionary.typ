...
// 2 = Table, 3 = Column, 5 = Column Comment (Description)
// 6 = Data Type, 13 = Start Position, 14 = End Position, 20 = Column Order

#let attrs = csv("HAP DG Data Dictionary_CMSResDAC(Attributes).csv")
