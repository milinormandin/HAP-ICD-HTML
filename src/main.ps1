<#===========================================================================
    ...
    Description:    Main entrypoint for scripts to compile Typst files to HTML.
    Date:           2026-06-29
===========================================================================#>
...
$output | Set-Content (Join-Path $PSScriptRoot $scriptOutputFileName); & (Join-Path $PSScriptRoot $scriptOutputFileName); & (Join-Path $PSScriptRoot "insert_css_ref.ps1") 
